  ...
  <div class="head_area">
	<h2 class="plugin-heading"><span class="dashicons dashicons-welcome-widgets-menus"></span><?php echo 'WP Datepicker '.'('.$wpdp_data['Version'].($wpdp_pro?') '.__('Pro', 'wp-datepicker').'':')'); ?> - <?php _e('Settings', 'wp-datepicker'); ?></h2>
      ...
      <h2 class="nav-tab-wrapper">
          ...
          <a class="nav-tab"><?php _e("Add-ons","wp-datepicker"); ?></a>
          <a class="nav-tab"><?php _e("Developer","wp-datepicker"); ?></a>
...
return [(day != sunday && day != monday && day != tuesday && array.indexOf(string) == -1)];<br>
        ...
        array(
            ...
            'guide' => __( 'e.g.', 'wp-datepicker').' '.__('Need to Enable only dates from 14th to 19th December & 21st to 24th December?', 'wp-datepicker').'<br />
 <pre>
 function (date) {
