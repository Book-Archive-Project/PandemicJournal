                ...
                <div class="sticky-wcp-custom-form">
                    ...
                    <div class="top-settings">
                        ...
                        <div class="sticky-folders">
                            <div class="sticky-title">Sticky Folders <span class="pull-right"><i class="pfolder-pin"></i></span></div>
                            <ul>
                    ...
                    <?php if(!$hasValidKey) { ?>
                        <div class="folder-form-buttons hide-it pro-message" id="pro-notice">
                            ...
                            <div class="pro-notice">
                                <a class="inline-button" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>">Activate your license key</a> to create subfolders (with 20+ amaizing features) & premium support 🎉
                            </div>
                        </div>
                    <?php } ?>
        ...
        <div class="popup-form-content">
            <div class="popup-form-data">
                ...
                <div class="folder-form-message">
                    Unlock unlimited amount of folders by activating license key.
                </div>
                <div class="folder-form-buttons">
                    <a href="javascript:;" class="form-cancel-btn">Cancel</a>
                    <a href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" target="_blank" class="form-submit-btn">Activate License Key</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="popup-form-content">
            <div class="popup-form-data">
                ...
                <div class="folder-form-message" style="padding: 25px 10px;" >
                    Hey, it looks like you want to create sub-folders on Folders. Sub-folders is a premium feature. Activate your license key to create, access and organize your files with sub-folders.
                </div>
                <div class="folder-form-buttons">
                    <a href="javascript:;" class="form-cancel-btn">Cancel</a>
                    <a href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" target="_blank" class="form-submit-btn">Activate license key</a>
