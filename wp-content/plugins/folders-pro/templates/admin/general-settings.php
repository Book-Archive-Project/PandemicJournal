        ...
        <div class="folders-tabs">
            <div class="folder-tab-menu">
                <ul>
                    ...
                    <?php if($isInSettings) { ?>
                        <li><a class="<?php echo esc_attr(($setting_page=="license-key")?"active":"") ?>" href="<?php echo esc_url($settingURL."&setting_page=license-key") ?>"><?php esc_html_e( 'License Key', WCP_FOLDER ); ?></a></li>
                    <?php } ?>
                </ul>
            </div>
                        ...
                        <div class="accordion-left">
                                                ...
                                                <td style="padding: 15px 10px 15px 0px" colspan="4">
                                                    <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                                        ...
                                                        <label for="" class="send-user-to-pro">
                                                            ...
                                                            <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your License key", WCP_FOLDER) ?></button>
                                                        </label>
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <td style="padding: 15px 10px 15px 0px" colspan="4">
                                                ...
                                                <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                                    ...
                                                    <label for="" class="send-user-to-pro">
                                                        ...
                                                        <button type="button" class="upgrade-link" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>"><?php esc_html_e("Activate your license key", WCP_FOLDER) ?></button>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <label for="show_media_details" >
                                                    <?php esc_html_e( 'Show media details on hover', WCP_FOLDER ); ?>
                                                    <span class="html-tooltip bottom">
                                                        <span class="dashicons dashicons-editor-help"></span>
                                                        <span class="tooltip-text top" style="">
                                                            Show useful metadata including title, size, type, date, dimension & more on hover.
                            ...
                            <div class="media-details">
                                <div class="">
                                    ...
                                    <div class="media-setting-box <?php echo (!$hasValidKey)?"active":($show_media_details == "on"?"active":"") ?> <?php echo (!$hasValidKey)?"send-user-to-pro":"" ?>" >
                                        ...
                                        <?php if(!$hasValidKey) { ?>
                                            <a class="upgrade-box" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                                <button type="button"><?php esc_html_e("Activate your License key", WCP_FOLDER) ?></button>
                                            </a>
                                        <?php } ?>
                                    </div>
                                </div>
                            ...
                            <table class="form-table">
                                ...
                                <tr>
                                    <td width="255px" class="no-padding">
                                        <?php if(!$hasValidKey) { ?>
                                        <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                            <label for="new_folder_color" ><b>"New Folder"</b> button color <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your license key", WCP_FOLDER) ?></button></label>
                                        </a>
                                        <?php } else { ?>
                                ...
                                <tr>
                                    <td class="no-padding">
                                        <?php if(!$hasValidKey) { ?>
                                        <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                            <label for="bulk_organize_button_color" ><b>"Bulk Organize"</b> button color <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your license key", WCP_FOLDER) ?></button></label>
                                        </a>
                                        <?php } else { ?>
                                ...
                                <tr>
                                    <td class="no-padding">
                                        <?php if(!$hasValidKey) { ?>
                                        <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                            <label for="media_replace_button" ><b>"Replace File"</b> media library button <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your license key", WCP_FOLDER) ?></button></label>
                                        </a>
                                        <?php } else { ?>
                                ...
                                <tr>
                                    <td class="no-padding">
                                        <?php if(!$hasValidKey) { ?>
                                        <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                            <label for="dropdown_color" >Dropdown color <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your license key", WCP_FOLDER) ?></button></label>
                                        </a>
                                        <?php } else { ?>
                                ...
                                <tr>
                                    <td class="no-padding">
                                        <?php if(!$hasValidKey) { ?>
                                        <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
                                            <label for="folder_bg_color" >Folders background color <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your license key", WCP_FOLDER) ?></button></label>
                                        </a>
                                        <?php } else { ?>
                                    ...
                                    <td class="no-padding">
                                        <label for="folder_font" >
	                                        <?php if($hasValidKey || ($setting_font !== false && $setting_font != "" && !in_array($setting_font, array("Arial","Tahoma","Verdana","Helvetica","Times New Roman","Trebuchet MS","Georgia")))) {
                                                ...
                                                <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
			                                        <?php esc_html_e( 'Folders font', WCP_FOLDER ) ?> <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your License key", WCP_FOLDER) ?></button>
                                                </a>
	                                        <?php } ?>
                                        </label>
                                    </td>
                                    ...
                                    <td class="no-padding">
                                        <label for="folder_size" >
                                            <?php if($folder_size === false || intval($folder_size) === 16) { ?>
                                                <a class="upgrade-box-link" target="_blank" href="<?php echo esc_url($this->getRegisterKeyURL()) ?>" >
		                                            <?php esc_html_e( 'Folders size', WCP_FOLDER ) ?> <button type="button" class="upgrade-link" ><?php esc_html_e("Activate your License key", WCP_FOLDER) ?></button>
                                                </a>
                                            <?php } else { ?>
