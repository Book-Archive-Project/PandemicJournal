...
<div class="folder-help-btn">
    ...
    <a class="folder-help-tooltip" href="javascript:;"><img src="<?php echo esc_url(WCP_PRO_FOLDER_URL."assets/images/owner.png") ?>" alt="<?php esc_html_e("Need help?", WCP_FOLDER) ?>"  /></a>
</div>
<script>
