...
class WCP_Pro_Forms {
    ...
    public static function get_form_html($option_data = "", $hasValidKey, $activateURL) {
        ob_start();
        ?>
            ...
            <div class="form-options">
                                ...
                                <li class="last folder-order">
                                    ...
                                    <div class="folder-sort-menu <?php echo ($hasValidKey)?"":"is-pro" ?>">
                                        <ul>
                                            ...
                                            <?php } else { ?>
                                                <li><a data-sort="n-o" target="_blank" class="pro-feature" href="<?php echo esc_url($activateURL) ?>"><?php esc_html_e("Sort by newest", WCP_FOLDER ) ?> <span><?php esc_html_e("(Activate)", WCP_FOLDER ) ?></span></a></li>
                                                <li><a data-sort="o-n" target="_blank" class="pro-feature" href="<?php echo esc_url($activateURL) ?>"><?php esc_html_e("Sort by oldest", WCP_FOLDER ) ?> <span><?php esc_html_e("(Activate)", WCP_FOLDER ) ?></span></a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                </li>
                ...
                <?php if(!($hasValidKey)) { ?>
                    <div class="upgrade-message">
                        <span class="upgrade-message"><a target="_blank" class="pink" href="<?php echo esc_url($activateURL) ?>"><?php esc_html_e("Activate your license key", WCP_FOLDER) ?> <span class="dashicons dashicons-arrow-right-alt"></span></a></span>
                    </div>
                <?php } ?>
            </div>
